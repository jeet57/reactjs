...
export default class App extends Component {
  ...
  this.homePaths=["/","/Home","/index","/AboutUs","about","/property","/blog","/blog-detail","/plans","/contact","/registration","/property-detail","/register-plans","/privacy-policy","/terms-condition"]
...
removeMain(){
  ...
  loadFile('https://code.jquery.com/jquery-1.10.2.js','js')
