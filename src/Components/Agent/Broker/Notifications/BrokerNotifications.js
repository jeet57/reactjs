...
export default class BrokerNotifications extends React.Component{
	render(){
		return(
			 <div>
        {/* Navigation Bar*/}
            ...
            <div className="container">
              <div id="navigation"> 
                ...
                <ul className="navigation-menu">
                  ...
                  <li> <a href="owner.html"><i className="fi-head " />Owner</a> </li>
                  <li> <a href="tenant.html"><i className="fi-head " />Tenant</a> </li>
