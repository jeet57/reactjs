                    ...
                    <div className="col-sm-4">
                      <div className="profile-user-box">
                        <span className="pull-left m-r-15">
                          <img src={profileInfo.profile_photo!=''?API_URL+'assetsadmin/'+profileInfo.profile_photo:img_not_available} alt="" className="thumb-lg rounded-circle" />
                        </span>
                      ...
                      <table className="table table-hover m-0 table-actions-bar">
                        ...
                        <tbody>
						 {AgentList.map((item,key)=>(
                          <tr key={item.name}>
                            <td><img src={item.profile_photo!=''?API_URL+'assetsadmin/'+item.profile_photo:img_not_available} alt="contact-img" title="contact-img" className="rounded-circle thumb-sm" /></td>
                            ...
                            <td><Link to={{"pathname":"/owner-agent-profile",state:{profileid:item.profile_id,session:JSON.parse(this.state.userData).session_id}}} className="view-icon"><i className="mdi mdi-eye"></i></Link></td>
                          </tr>
						 ))}
              ...
              <div className="row">
                <div className="col-md-4"> 
                  ...
                  <div className="card-box">
                    ...
                    <div className="panel-body"> 
                    <img id="single-image" src={this.state.property.img_path!=''?API_URL+'assetsadmin/'+this.state.property.img_path:img_not_available} alt="image-1" className="img-fluid" />
                      <hr/>
                      ...
                      <table className="table table-hover m-0 table-actions-bar">
						...
						{TenantList.map((item,key)=>(
                          <tr>
                            ...
                            <td><i className="mdi mdi-map-marker text-primary"></i> {item.country}</td>
                            <td>{item.connectedDate}</td>
                            <td><Link to={{"pathname":"/profile-details",state:{profileid:item.profile_id,session:JSON.parse(this.state.userData).session_id}}} className="view-icon"><i className="mdi mdi-eye"></i></Link></td>
                          </tr>
						   ))}
