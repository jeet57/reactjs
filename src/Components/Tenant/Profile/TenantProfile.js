              ...
              <div className="col-sm-12">
                <div className="row">
                  <div className="col-sm-4">
                    <div className="profile-user-box1"> <span className="pull-left m-r-15"><img src={profileInfo.profile_photo!=''?API_URL+'assetsadmin/'+profileInfo.profile_photo:img_not_available} alt className="thumb-lg rounded-circle" /></span>
                      ...
                      <div className="col-sm-3">
                        <div className="card-box widget-box-four">
                          ...
                          <div className="wigdet-four-content">
                            ...
                            <h3 className="m-b-0 m-t-35"><span>{this.state.statics.Agent}</span> <span data-plugin="counterup" className="profile-icon"><i className="fi-head " /></span></h3>
                          </div>
                          <div className="clearfix" />
                        </div>
                      </div>
            ...
            <div className="row">
              <div className="col-md-4"> 
                ...
                <div className="card-box">
                  ...
                  <div className="panel-body"> <img id="single-image" src={this.state.property!=''?API_URL+'assetsadmin/'+this.state.property.img_path:img_not_available} alt="image-1" className="img-fluid" />
                      <hr/>
